...
public class Player
{
  ...
  Position getNextMove(Board board) {
    // Make a score system (Points 0 - 3)
    // Parameter: Prioritize getting Corner Spaces (score: 3)
    // Parameter: Prioritize getting Border Spaces (score: 2)
    // Parameter: Avoid "Death Areas" around Corner Spaces (score: 0)
    // Anything Else Go to Random Spot (score: 1)
    return null;
  };
